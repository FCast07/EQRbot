...
def eqr(s):
    ...
    explanation = """Given the patient previous data and the current '{}' and '{}' due to '{}',_
the expertise of the '{}' in the field of '{}'_
recommends '{}' as an effective treatment._
This should lead to the '{}'_
which will bolster the goal of '{}'_
and promote the '{}'.""".format(bindings["R1"],bindings["R2"],bindings["R3"],bindings["E"],bindings["F"],bindings["T"],bindings["S"],bindings["G"],bindings["V"])

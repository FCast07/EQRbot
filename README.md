...
#### An example video of the chatbot implementation can be found on [Youtube](https://youtu.be/wtn78UWSoOY) or by downloading the above [EQRbotExampleVideo.zip](https://github.com/FCast07/EQRbot/blob/main/EQRbotExampleVideo.zip) file. 
